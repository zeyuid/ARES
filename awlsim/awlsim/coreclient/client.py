...
class AwlSimClient(object):
	...
	def sleep(self, seconds):
		time.sleep(seconds)
	# send CPU state on client to awlsim server # send CPU state on client to awlsim server # send CPU state on client to
	...
	# Write memory areas in the server, the CPU core.
